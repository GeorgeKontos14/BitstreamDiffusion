# configs/text_audio/libritts/libritts_train.py
#
# Small-scale run: joint audio+text bitstream diffusion on LibriTTS (~350K pairs),
# StableCodec speech tokens ("1x46656_400bps"), BiCodec speaker tokens, SDT small 12x768 (~134M),
...
#   = 1000 positions * 18 bits = 18000 bits.

# Trainer: 4 A100 / 1 node, global batch 512 (128/GPU), multi-node launcher
...
def get_config():
    ...
    def add_textaudio_spec(sampler_name, target_nfes, stochastic_enabled=False, s_churns=None):
