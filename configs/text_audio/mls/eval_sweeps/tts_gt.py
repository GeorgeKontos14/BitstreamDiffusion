...
def get_config():
    ...
    cfg.data.tts_gt_cache_path = 'datasets/test_common/cache_test_clean_tts_632_actual_global_common.uint32'
    cfg.data.tts_gt_meta_path = 'datasets/test_common/cache_test_clean_tts_632_actual_global.meta.json'
    ...
    add_eval_textaudio_spec(
        ...
        gamma_targets=[0.27], guidance_scales=[5.0], tasks=['tts_gt'],
    )
