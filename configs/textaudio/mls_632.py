...
def get_config():
    ...
    def add_textaudio_spec(sampler_name, target_nfes, stochastic_enabled=False, s_churns=None, guidance_scales=None):
    ...
    add_textaudio_spec('ddim_entropic', target_nfes=[256, 512])
    add_textaudio_spec('ddim_entropic', target_nfes=[256], stochastic_enabled=True, s_churns=[33.15])
    add_textaudio_spec('ddim_entropic', target_nfes=[512], stochastic_enabled=True, s_churns=[63.75])
    ...
    cfg.logging.project = "cobit_630M_632"
